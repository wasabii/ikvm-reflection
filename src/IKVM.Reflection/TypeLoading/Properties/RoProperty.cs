...
namespace IKVM.Reflection.TypeLoading
{
    ...
    internal abstract partial class RoProperty : LeveledPropertyInfo
    {
        ...
        private RoMethod? GetRoGetMethod() => ReferenceEquals(_lazyGetter, Sentinels.RoMethod) ? (_lazyGetter = ComputeGetterMethod()?.FilterInheritedAccessor()) : _lazyGetter;
        private RoMethod? GetRoSetMethod() => ReferenceEquals(_lazySetter, Sentinels.RoMethod) ? (_lazySetter = ComputeSetterMethod()?.FilterInheritedAccessor()) : _lazySetter;
