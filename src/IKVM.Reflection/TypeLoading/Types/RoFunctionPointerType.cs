...
namespace IKVM.Reflection.TypeLoading
{
    ...
    internal sealed class RoFunctionPointerType : RoType
    {
        ...
        public sealed override bool Equals(Type? type) => Equals((object?)type);
        ...
        public sealed override Type MakeGenericType(params Type[] typeArguments) => throw new InvalidOperationException(string.Format(SR.Arg_NotGenericTypeDefinition, this));
