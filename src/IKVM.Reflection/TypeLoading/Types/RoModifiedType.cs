...
namespace IKVM.Reflection.TypeLoading
{
    ...
    internal abstract class RoModifiedType : RoType
    {
        ...
        public override Type[] GetRequiredCustomModifiers()
        {
            ...
            return _requiredModifiers.CloneArray();
        }
        ...
        public override Type[] GetOptionalCustomModifiers()
        {
            ...
            return _optionalModifiers.CloneArray();
        }
        ...
        public override bool Equals(object? obj) => throw new NotSupportedException(SR.NotSupported_ModifiedType);
