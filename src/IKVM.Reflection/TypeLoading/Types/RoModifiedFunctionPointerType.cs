...
namespace IKVM.Reflection.TypeLoading
{
    ...
    internal sealed class RoModifiedFunctionPointerType : RoModifiedType
    {
        ...
        public override Type[] GetFunctionPointerParameterTypes() => _parameterTypes.CloneArray();
        public override Type[] GetFunctionPointerCallingConventions() => _callingConventions.CloneArray();
        ...
        private Type[] CreateCallingConventions(Type[] returnTypeOptionalModifiers, RoFunctionPointerType functionPointerType)
        {
            ...
            switch (functionPointerType.CallKind)
            {
                ...
                case System.Reflection.Metadata.SignatureCallingConvention.FastCall:
                    ...
                    break;
                case System.Reflection.Metadata.SignatureCallingConvention.Unmanaged:
