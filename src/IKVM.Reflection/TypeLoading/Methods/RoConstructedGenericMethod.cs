...
namespace IKVM.Reflection.TypeLoading
{
    ...
    internal sealed partial class RoConstructedGenericMethod : RoMethod
    {
        ...
        public sealed override MethodInfo MakeGenericMethod(params Type[] typeArguments) => throw new InvalidOperationException(string.Format(SR.Arg_NotGenericMethodDefinition, this));
