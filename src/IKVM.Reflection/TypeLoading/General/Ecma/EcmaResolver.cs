    ...
    internal static class EcmaResolver
    {
        ...
        private static RoDefinitionType ComputeTypeRefResolution(TypeReferenceHandle handle, EcmaModule module)
        {
            ...
            switch (scopeKind)
            {
                ...
                case HandleKind.TypeReference:
                    {
                        ...
                        return nestedType ?? throw new TypeLoadException(string.Format(string.Format(SR.TypeNotFound, outerType.ToString() + "[]", outerType.Assembly.FullName)));
                    }
                ...
                case HandleKind.ModuleReference:
                    {
                        ...
                        if (targetModule == null)
                            throw new BadImageFormatException(string.Format(SR.BadImageFormat_TypeRefModuleNotInManifest, module.Assembly.FullName, $"0x{handle.GetToken():x8}"));
                ...
                default:
                    throw new BadImageFormatException(string.Format(SR.BadImageFormat_TypeRefBadScopeType, module.Assembly.FullName, $"0x{handle.GetToken():x8}"));
            }
        }
