...
namespace IKVM.Xmil.Reflection.Metadata.Compile
{
    ...
    public class MetadataAssemblyBuilder : IAssemblyBuilder
    {
        ...
        {
            return new MetadataModuleWriter(metadataBuilder, metadataBuilder.AddModule(0, metadataBuilder.GetOrAddString(name), metadataBuilder.GetOrAddGuid(mvid), default, default));
        }
